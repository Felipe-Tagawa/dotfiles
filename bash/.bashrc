...
alias drive='~/.scripts/abrir_drive.sh'
...
# Corrige o cedilha no teclado US International
export GTK_IM_MODULE=cedilla
export QT_IM_MODULE=cedilla

alias bit='vivaldi-stable --app=https://vault.bitwarden.com/#/vault'

alias teclado-br='setxkbmap -model abnt2 -layout br -variant abnt2'
alias teclado-us='setxkbmap -layout us'
